...
<div class="mx-auto p-5">
    <div class="card">
        <div class="card-header">
            <span class="fa-solid fa-trophy"></span>CAPTURA LA INFORMACIÓN DEL TORNEO  
        </div>
        <div class="card-body">
            <form action="torneosInsert.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <span id="patrocinador" class="form-text">
                        Atención: se puede separar con "," si hay mas de un patrocinador.
                    </span>
                </div>
                <div class="row">
                    <div class="col mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col mb-3">
                        <label for="Otro premio" class="form-label">OTRO PREMIO (CAMPEÓN CANASTERO)</label>
